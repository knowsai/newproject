...
<link href="/resources/css/wickedpicker.css" rel="stylesheet" type='text/css' media="all" />  <!-- time-picker-CSS -->
<!-- //Custom Theme files --> 
<!-- js -->
	...
	<div class="specials">  
		...
		<div id="owl-demo" class="owl-carousel text-center">
			<div class="item g1 popup-with-zoom-anim">
				<img class="lazyOwl" src="/resources/images/g1.jpg" alt="Veg Mores">
			...
			<div class="item g1 popup-with-zoom-anim">
				<img class="lazyOwl" src="/resources/images/g2.jpg" alt="Veg Mores">
				<div class="agile-caption">
					<h4>Our Specials</h4>
					<span>Neque porro quisquam est qui dolorem </span>
				</div>
			...
			<div class="item g1 popup-with-zoom-anim">
				<img class="lazyOwl" src="/resources/images/g3.jpg" alt="Veg Mores">
				<div class="agile-caption">
					<h4>Our Specials</h4>
					<span>Neque porro quisquam est qui dolorem </span>
				</div>
			...
			<div class="item g1 popup-with-zoom-anim">
				<img class="lazyOwl" src="/resources/images/g4.jpg" alt="Veg Mores">
				<div class="agile-caption">
					<h4>Our Specials</h4>
					<span>Neque porro quisquam est qui dolorem </span>
				</div>
