...
<body>
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i>  &raquo; <a href="{{url('admin/navs')}}">自定义导航栏管理</a> &raquo; 添加自定义导航栏
    </div>
    <!--面包屑导航 结束-->
	...
	<div class="result_wrap">
        ...
        <div class="result_content">
            <div class="short_wrap">
                <a href="{{ url('admin/navs/create') }}"><i class="fa fa-plus"></i>添加自定义导航栏</a>
            ...
            <table class="add_tab">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="nav_name"><input type="text" name="nav_alias" class="sm">
