...
<body>
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{ url('admin/info') }}">首页</a> &raquo; 自定义导航栏管理
    </div>
    <!--面包屑导航 结束-->
        ...
        <div class="result_wrap">
            ...
            <div class="result_content">
                <div class="short_wrap">
                    <a href="{{ url('admin/navs/create') }}"><i class="fa fa-plus"></i>添加</a>
        ...
        <div class="result_wrap">
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <tr>
                        <td class="tc">
                            <input type="text" onchange="changOrder(this,{{ $v->nav_id }})" value="{{ $v->nav_order }}">
                        </td>
                        <td>
                            {{ $v->nav_id }}
                        </td>
...
<script>
    function changOrder(obj,nav_id){
