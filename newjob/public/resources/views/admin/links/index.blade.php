        ...
        <div class="result_wrap">
            ...
            <div class="result_content">
                <div class="short_wrap">
                    <a href="{{ url('admin/links/create') }}"><i class="fa fa-plus"></i>添加</a>
        ...
        <div class="result_wrap">
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <tr>
                        <td class="tc">
                            <input type="text" onchange="changOrder(this,{{ $v->link_id }})" value="{{ $v->link_order }}">
                        </td>
                        <td>
                            {{ $v->link_id }}
                        </td>
...
<script>
    function changOrder(obj,link_id){
